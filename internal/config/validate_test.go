...
// Core validation coverage for server / database / keys / rate_limit /
// security / trust_policy / transparency / cluster-core fields. TLS,
// trusted notaries and raft-specific validation live next door in
// validate_cluster_test.go so this file stays under the 300-line
// target.
