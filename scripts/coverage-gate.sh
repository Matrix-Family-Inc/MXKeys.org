...
declare -a COVERAGE_PACKAGE_FLOORS=(
  ...
  "mxkeys/internal/zero/canonical=45"
  "mxkeys/internal/zero/metrics=40"
  "mxkeys/internal/storage/migrations=75"
  "mxkeys/internal/zero/nettls=70"
  "mxkeys/internal/zero/raft/walupgrade=65"
)
