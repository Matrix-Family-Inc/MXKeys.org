    ...
    <section className="py-20 bg-[var(--color-bg-surface)]">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          <div className="card">
            <h3 className="font-semibold text-[var(--color-text)] mb-4">{t('integration.mxcore')}</h3>
          ...
          <div className="card">
            <h3 className="font-semibold text-[var(--color-text)] mb-4">{t('integration.synapse')}</h3>
            <div className="code-block">
